...
def start_training(character: Character) -> str:
    ...
    """
    # Приветственное сообщение с описанием персонажа
    print(f'{character.name}, ты {character.__class__.__name__} — {character.BRIEF_DESC_CHAR_CLASS}.')
    ...
    # Словарь команд, где ключ — команда, значение — метод объекта
    commands = {
    ...
    while True:
        ...
        if cmd == 'skip':  # Прекращение тренировки
            break
        # Выполнение команды, если она существует в словаре
        elif cmd in commands:
            print(commands[cmd]())  # Вызов метода из словаря
        else:
...
def main():
    ...
    char_name = input("...назови себя: ").strip('\r\n')
